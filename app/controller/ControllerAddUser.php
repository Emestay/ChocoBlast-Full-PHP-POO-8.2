...
if (isset($_POST['submit'])) {
    ...
    if (!empty($nom) && !empty($prenom) && !empty($mail) && !empty($password)) {
        ...
        if (!$user->getUserByMail()) {
            ...
            header('refresh:3;url=http://localhost/chocoFull/app/vue/view_add_user.php');
            echo 'Bien joué tu vas etre rediriggé dans 3 secs. Sinon, <a href="http://localhost/chocoFull/app/vue/view_add_user.php">clique la</a>.';
